...
> Версия проекта: 0.1.5 — ~141 Python-модуль, ~27.8K LOC, 1034 pytest-кейса
...
└── tests/                  # Тесты (1034 pytest-кейса, 106 Python test-файлов)
```
...
| **Исходники** | **~27,828** | **~141** |
| **Тесты** | **~21,574** | **~106** |
| **Тест-кейсов pytest** | **1034** | |
