...
> Версия проекта: 0.1.6 — ~141 Python-модуль, ~28.0K LOC, 1039 pytest-кейсов
...
└── tests/                  # Тесты (1039 pytest-кейсов, 106 Python test-файлов)
```
...
| **Исходники** | **~28,008** | **~141** |
| **Тесты** | **~21,777** | **~106** |
| **Тест-кейсов pytest** | **1039** | |
